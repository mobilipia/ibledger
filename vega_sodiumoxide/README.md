...
[![Build Status](https://travis-ci.org/vega/vega_sodiumoxide.svg?branch=master)](https://travis-ci.org/vega/vega_sodiumoxide)
[![Build status](https://ci.appveyor.com/api/projects/status/v8fsl1hd6dq9bct1?svg=true)](https://ci.appveyor.com/project/DarkEld3r/vega-sodiumoxide)
...
--------
```rust
extern crate vega_sodiumoxide;

vega_sodiumoxide::init();
```
...
Master git repository
    ...
    git clone https://github.com/vega/vega_sodiumoxide.git

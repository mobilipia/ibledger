...
//! # Migrations Overview
//!
//! The goal of a data migration is to prepare data of an Vega service for use with an updated
...
//! [database capabilities]: https://docs.rs/vega-merkledb/latest/vega_merkledb/migration/
...
use vega_merkledb::migration::{self as db_migration, MigrationHelper};
use failure::Fail;
use semver::Version;
...
/// [`MigrationHelper`]: https://docs.rs/vega-merkledb/latest/vega_merkledb/migration/struct.MigrationHelper.html

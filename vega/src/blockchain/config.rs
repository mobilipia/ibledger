...
/// [configuration update service](https://vega.com/doc/version/latest/advanced/configuration-updater/).
///
...
///
/// For additional information on the Vega consensus algorithm, refer to
/// [Consensus in Vega](https://vega.com/doc/version/latest/architecture/consensus/).
...
///
/// ```
/// # use vega::blockchain::{ConsensusConfig, ConsensusConfigBuilder};

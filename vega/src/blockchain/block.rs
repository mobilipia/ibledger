...
use vega_merkledb::{BinaryValue, MapProof};
...
/// provided by corresponding Protobuf definitions, but cannot expect Vega nodes
/// or the `vega` crate to accept and process `Block`s created externally.
...
impl Block {
    ...
    ///
    /// ```
    /// # use vega::crypto::Hash;
    /// # use vega::blockchain::{Block, BlockHeaderKey, AdditionalHeaders};
    /// # use vega::helpers::Height;
    /// # use vega::merkledb::BinaryValue;
    /// # use failure::Error;
    /// # use std::borrow::Cow;

...
/// Information schema for indexes maintained by the Vega core logic.
///
...
///
/// Vega isolates execution of the transactions included into the the block,
...
///
/// ```rust
/// # use vega::blockchain::CallInBlock;
...
/// an error may occur. Since Vega services may call each other's methods, `CallSite` is

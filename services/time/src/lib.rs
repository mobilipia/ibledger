...
//!
//! See [the Vega documentation][docs:time] for a high-level overview of the
//! service, in particular, its design rationale and the proof of correctness.
//!
//! [docs:time]: https://vega.com/doc/version/latest/advanced/time
//!
//! # HTTP API
//!
...
//! };
//! use vega_rust_runtime::ServiceFactory;
//! use vega_testkit::{TestKit, TestKitBuilder};
//! use vega_time::{MockTimeProvider, TimeProvider, TimeSchema, TimeServiceFactory};
//!
//! use std::sync::Arc;
//!
...
//!
//! [at GitHub]: https://github.com/vega/vega/blob/master/services/time/examples/simple_service/main.rs
...
use vega_derive::{ServiceDispatcher, ServiceFactory};
use vega_rust_runtime::{api::ServiceApiBuilder, AfterCommitContext, Service};

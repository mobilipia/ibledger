...
//! # use vega_explorer_service::{api::BlocksRange, ExplorerFactory};
...
//! ```
//! # use vega::helpers::Height;
//! # use vega_explorer_service::{api::BlockInfo, ExplorerFactory};
//! # use vega_testkit::TestKitBuilder;
//! # fn main() -> Result<(), failure::Error> {
//! # let mut testkit = TestKitBuilder::validator()
//! #    .with_default_rust_service(ExplorerFactory)
...
//! # };
//! # use vega_rust_runtime::{ExecutionContext, DefaultInstance, Service, ServiceFactory};
//! # use vega_derive::*;
//! # use vega_explorer_service::{api::{TransactionQuery, TransactionInfo}, ExplorerFactory};
//! # use vega_testkit::TestKitBuilder;
//! #[vega_interface]
...
//! # use vega_rust_runtime::{ExecutionContext, DefaultInstance, Service, ServiceFactory};
//! # use vega_derive::*;
//! # use vega_explorer_service::{api::{TransactionQuery, CallStatusResponse}, ExplorerFactory};
//! # use vega_testkit::TestKitBuilder;
//! #[vega_interface]
//! trait ServiceInterface<Ctx> {
//!     type Output;
...
//! # use vega_rust_runtime::{ExecutionContext, DefaultInstance, Service, ServiceFactory};
//! # use vega_derive::*;
//! # use vega_explorer_service::{api::{CallStatusQuery, CallStatusResponse}, ExplorerFactory};
//! # use vega_testkit::TestKitBuilder;
//! #[derive(Debug, ServiceDispatcher, ServiceFactory)]
//! # #[service_factory(artifact_name = "my-service")]
//! struct MyService;
...
//! # use vega_rust_runtime::{ExecutionContext, DefaultInstance, Service, ServiceFactory};
//! # use vega_derive::*;
//! # use vega_explorer_service::{api::{TransactionHex, TransactionResponse}, ExplorerFactory};
//! # use vega_testkit::TestKitBuilder;
//! #[vega_interface]
//! trait ServiceInterface<Ctx> {
//!     type Output;
...
use vega_explorer::{median_precommits_time, BlockchainExplorer};
use vega_rust_runtime::api::{self, ServiceApiScope};

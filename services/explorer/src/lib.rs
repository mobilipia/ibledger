...
//! crate, [`vega-explorer`]. The base explorer provides Rust language APIs for retrieving info
//! from the blockchain, while this crate translates these APIs into REST and WebSocket endpoints
//! and packages this logic as an Vega service. Thus, this crate is useful if you want to provide
...
//!
//! ```
//! use vega_explorer::api::BlocksRange;
//! use vega_explorer_service::ExplorerFactory;
//! use vega_testkit::{ApiKind, TestKit, TestKitBuilder};
//!
...
//! ```
//!
//! [`vega-explorer`]: https://docs.rs/vega-explorer
...
use vega_derive::*;
use vega_rust_runtime::{api::ServiceApiBuilder, AfterCommitContext, DefaultInstance, Service};

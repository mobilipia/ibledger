...
//! # use vega_explorer_service::api::websocket::{
...
//! ```
//! # use assert_matches::assert_matches;
//! # use vega::{crypto::gen_keypair, runtime::ExecutionError};
//! # use vega_rust_runtime::{ExecutionContext, DefaultInstance, Service, ServiceFactory};
//! # use vega_derive::*;
//! # use vega_explorer_service::ExplorerFactory;
//! # use vega_explorer_service::api::{
...
pub use vega_explorer::api::websocket::{
...
use vega_explorer::api::{TransactionHex, TransactionResponse};

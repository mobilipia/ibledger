...
use vega_derive::*;
use vega_rust_runtime::{ArtifactProtobufSpec, Service, ServiceFactory};

use vega_middleware_service::ArtifactReq;

#[derive(Debug, FromAccess, RequireArtifact)]
#[require_artifact(name = "vega.services.test.Inc", version = "*")]
...
impl IncFactory {
    pub const ARTIFACT_NAME: &'static str = "vega.services.test.Inc";

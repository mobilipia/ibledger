...
use vega::runtime::{AnyTx, CoreError, ExecutionContext, ExecutionError, InstanceId};
use vega_derive::*;
use vega_proto::ProtobufConvert;
use vega_rust_runtime::{FallthroughAuth, GenericCall, GenericCallMut, MethodDescriptor, TxStub};
...
/// }
///
/// # use vega::runtime::InstanceId;
/// # use vega_rust_runtime::DefaultInstance;
/// use vega_middleware_service::{
...
/// let req: ArtifactReq = "vega.Token@1".parse().unwrap();

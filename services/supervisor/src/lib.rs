...
//! Supervisor is an [Vega][vega] service capable of the following activities:
//!
...
//! the Vega [runtime module][runtime-docs].
//!
...
#[service_factory(proto_sources = "proto", artifact_name = "vega-supervisor")]

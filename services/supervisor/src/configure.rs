...
use vega::runtime::{CommonError, ExecutionContext, ExecutionError, InstanceId, MethodId};
use vega_merkledb::BinaryValue;
use vega_rust_runtime::{GenericCallMut, Interface, MethodDescriptor};

/// Fully qualified name of the ['Configure`] interface.
///
/// ['Configure`]: trait.Configure.html
pub const CONFIGURE_INTERFACE_NAME: &str = "vega.Configure";

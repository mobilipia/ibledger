...
`vega-supervisor` is a main service of the [Vega blockchain framework](https://vega.com/).
...
Supervisor is an Vega service capable of the following activities:
...
documentation for the Vega [runtime module][runtime-docs].
...
Consult [the crate docs](https://docs.rs/vega-supervisor) for more details
about the service API.

## Usage

Include `vega-supervisor` as a dependency in your `Cargo.toml`:

```toml
[dependencies]
vega = "0.1.0"
vega-supervisor = "0.1.0"
```

## License

`vega-supervisor` is licensed under the Apache License (Version 2.0).

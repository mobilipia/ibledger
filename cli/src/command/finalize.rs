...
//! Standard Vega CLI command used to combine a private and all the public parts of the
//! node configuration in a single file.

use vega::crypto::PublicKey;
use vega_node::{ConnectInfo, ConnectListConfig, NodeApiConfig};

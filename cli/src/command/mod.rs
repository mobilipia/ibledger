...
//! Standard Vega CLI node configuration commands.
...
/// Interface of standard Vega Core configuration command.
pub trait vegaCommand {
    /// Returns the result of the command execution.
    fn execute(self) -> Result<StandardResult, Error>;
}

/// Standard Vega Core configuration command.
...
/// Output of any of the standard Vega Core configuration commands.

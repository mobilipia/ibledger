...
//! Standard Vega CLI command used to perform different maintenance actions.

use vega::merkledb::{Database, RocksDB};
use vega_node::helpers::clear_consensus_messages_cache;
use failure::Error;
...
impl vegaCommand for Maintenance {

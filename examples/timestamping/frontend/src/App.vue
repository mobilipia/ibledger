    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container">
        <router-link :to="{ name: 'index' }" class="navbar-brand">
          <img src="images/vega.png" width="41" height="36" class="align-middle mr-2" alt="">
          Timestamping
        </router-link>
        ...
        <div class="row">
          <div class="col-sm-12">
            <ul class="list-unstyled">
              <li>Source code on <a href="https://github.com/vega/timestamping-demo" target="_blank">GitHub</a></li>
              <li>Works on <a href="https://vega.com/doc/" target="_blank">Vega</a></li>
            </ul>
          </div>
        </div>
      </div>

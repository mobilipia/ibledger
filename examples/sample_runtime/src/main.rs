...
use vega_rust_runtime::{RustRuntime, ServiceFactory};
use vega_supervisor::{ConfigPropose, DeployRequest, Supervisor, SupervisorInterface};
    ...
    fn update_service_status(
        ...
        match status {
            InstanceStatus::Active => {
                ...
                // `vega` guarantees that `initiate_adding_service` was invoked

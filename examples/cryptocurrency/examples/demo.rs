...
use vega_node::{NodeApiConfig, NodeBuilder, NodeConfig};
use vega_rust_runtime::{DefaultInstance, RustRuntime, ServiceFactory};
use vega_system_api::SystemApiPlugin;

use vega_cryptocurrency::contracts::CryptocurrencyService;

fn node_config() -> NodeConfig {
    let (consensus_public_key, consensus_secret_key) = vega::crypto::gen_keypair();
    let (service_public_key, service_secret_key) = vega::crypto::gen_keypair();

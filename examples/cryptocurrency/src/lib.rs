...
//! Demo [Vega][vega] service implementing a simple cryptocurrency.
...
//! [docs]: https://vega.com/doc/version/latest/get-started/create-service
//! [readme]: https://github.com/vega/cryptocurrency#readme
...
pub mod schema {
    ...
    use vega_derive::{BinaryValue, FromAccess, ObjectHash};
    ...
    //
    // [1]: https://vega.com/doc/version/latest/architecture/serialization
...
/// Contracts.
pub mod contracts {
    use vega::runtime::{ExecutionContext, ExecutionError};
    use vega_derive::{vega_interface, interface_method, ServiceDispatcher, ServiceFactory};
    use vega_rust_runtime::{api::ServiceApiBuilder, Service};
...
pub mod api {
    use vega::crypto::PublicKey;
    use vega_rust_runtime::api::{self, ServiceApiBuilder, ServiceApiState};

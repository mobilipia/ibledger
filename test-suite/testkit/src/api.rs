...
use vega_api::{self as api, ApiAggregator};
use futures::Future;
use log::{info, trace};
use reqwest::{
...
/// Kind of public or private REST API of an Vega node.
///
...
pub enum ApiKind {
    ...
    Explorer,
    /// `api/runtimes/rust` endpoints corresponding to Rust runtime of the Vega REST API.
    RustRuntime,

...
/// # };
/// use vega::merkledb::access::AccessExt;
/// # use vega_rust_runtime::Service;
/// use vega_testkit::migrations::{MigrationTest, ScriptExt};
///
...
/// use vega::merkledb::access::AccessExt;
/// # use vega_rust_runtime::Service;
/// use vega_testkit::migrations::{AbortPolicy, MigrationTest, ScriptExt};
///
...
///
/// ```
/// # use vega::runtime::migrations::{MigrationContext, MigrationError, MigrationScript};
/// # use vega_derive::*;
/// use vega_testkit::migrations::ScriptExt as _;
///
...
mod tests {
    ...
    use vega_rust_runtime::{ArtifactProtobufSpec, Service};
    ...
    impl ServiceFactory for SomeService {
        fn artifact_id(&self) -> ArtifactId {
            ArtifactId::from_raw_parts(0, "vega.test.Migrations".into(), Version::new(0, 3, 2))
        }

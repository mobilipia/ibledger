"""Library for writing integration tests for Vega."""
import os
...
class vegaNetwork:
    """Class representing runner of the Vega network.
    ...
    def __enter__(self) -> "vegaNetwork":
        return self
    ...
    def generate_template(self, validators_count: int, supervisor_mode: str = "simple") -> None:
        ...
        # {vega-app} generate-template example/common.toml \
    ...
    def generate_config(self, validator_id: int, peer_address: str) -> None:
        ...
        # {vega_app} generate-config example/common.toml  example/1 --peer-address 127.0.0.1:6331 -n
        args = [common_config]
    ...
    def finalize(self, validator_id: int, public_api_address: str, private_api_address: str) -> None:
        ...
        # {vega_app} finalize --public-api-address 0.0.0.0:8200 --private-api-address 0.0.0.0:8091 \
    ...
    def run_node(self, validator_id: int) -> None:
        ...
        # {vega_app} run --node-config example/1/node.toml --db-path example/1/db \

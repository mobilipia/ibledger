...
//! that is, the Vega process has exclusive access to the DB during blockchain operation.
...
//! to the entire Merkelized database contents. For example, this is used in [Vega] to achieve
...
//! [doc:storage]: https://vega.com/doc/architecture/storage
...
// Workaround for 'Linked file at path {vega_merkledb_path}/struct.ProofMapIndex.html
// does not exist!'
#[doc(no_inline)]

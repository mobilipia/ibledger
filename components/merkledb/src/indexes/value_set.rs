    ...
    V: BinaryValue + ObjectHash,
{
    ...
    ///
    /// ```
    /// use vega_merkledb::{access::AccessExt, TemporaryDB, Database, ValueSetIndex};
    ///
    ...
    ///
    /// let data = vec![1, 2, 3];
    /// let data_hash = vega_crypto::hash(&data);
    ...
    /// is [Hash](../../../vega_crypto/struct.Hash.html).
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// hash. The iterator element type is [Hash](../../../vega_crypto/struct.Hash.html).
    ///
    /// # Examples
    ///
    /// ```

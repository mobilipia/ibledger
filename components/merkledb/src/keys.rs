...
use vega_crypto::{Hash, PublicKey, Signature, HASH_SIZE, PUBLIC_KEY_LENGTH, SIGNATURE_LENGTH};
...
mod tests {
    ...
    // Example how to migrate from Vega <= 0.5 implementation of `BinaryKey`
    // for signed integers.
    #[test]

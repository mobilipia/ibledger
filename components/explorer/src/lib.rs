...
//!
//! [explorer-service]: https://docs.rs/vega-explorer-service/
//! [`BlockWithTransactions`]: struct.BlockWithTransactions.html
//! [testkit]: https://docs.rs/vega-testkit/latest/vega_testkit/struct.TestKit.html
...
///
/// [`Block`]: https://docs.rs/vega/latest/vega/blockchain/struct.Block.html
/// [`Precommit`]: https://docs.rs/vega/latest/vega/messages/struct.Precommit.html
/// [`Hash`]: https://docs.rs/vega-crypto/latest/vega_crypto/struct.Hash.html
#[derive(Debug)]
...
///   has occurred.
///
/// [`TxLocation`]: https://docs.rs/vega/latest/vega/blockchain/struct.TxLocation.html
/// [`ListProof`]: https://docs.rs/vega-merkledb/latest/vega_merkledb/indexes/proof_list/struct.ListProof.html
/// [`Hash`]: https://docs.rs/vega-crypto/latest/vega_crypto/struct.Hash.html
/// [`ExecutionStatus`]: https://docs.rs/vega/latest/vega/runtime/struct.ExecutionStatus.html
/// [`ExecutionError`]: https://docs.rs/vega/latest/vega/runtime/struct.ExecutionError.html
/// [`CoreError`]: https://docs.rs/vega/latest/vega/runtime/enum.CoreError.html
/// [`CommonError`]: https://docs.rs/vega/latest/vega/runtime/enum.CommonError.html
...
///
/// ```
/// use vega_explorer::TransactionInfo;
/// use vega::{crypto::gen_keypair, runtime::InstanceId};
/// # use vega_derive::*;
/// # use serde_derive::*;
/// # use serde_json::json;
///
...
///
/// [`Snapshot`]: https://docs.rs/vega-merkledb/latest/vega_merkledb/trait.Snapshot.html

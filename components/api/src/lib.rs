...
//! High-level wrapper around a web server used by the Vega framework.
//!
...
//! for the Vega node. The Rust runtime provides its own abstractions based on the wrapper;
//! consult its docs for details. Node plugins use [`ApiBuilder`] directly.
//!
//! [`actix`]: https://crates.io/crates/actix
//! [rust-runtime]: https://crates.io/crates/vega-rust-runtime
...
/// This trait is used to implement an API backend for Vega.
...
/// Vega API builder for the concrete API scope or, in other words,
...
/// Vega API builder, which is used to add endpoints to the node API.
#[derive(Debug, Clone, Default)]
...
/// Vega API access level, either private or public.

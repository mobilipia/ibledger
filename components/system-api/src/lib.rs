...
//! System API of an Vega node, packaged as a node plugin.
//!
//! # Examples
//!
...
//! };
//! use vega_node::{NodeBuilder, NodeConfig};
//! use vega_system_api::SystemApiPlugin;
//!
...
//!
//! ```
//! use vega_system_api::{private::NodeInfo, SystemApiPlugin};
...
use vega::blockchain::{ApiSender, Blockchain};
...
/// Plugin responsible for adding system API to the Vega node.
///

...
use vega::{blockchain::ApiSender, crypto::PublicKey, runtime::InstanceId};
use vega_api::{self as api, ApiBackend, ApiScope};
use vega_node::{ConnectInfo, ExternalMessage, SharedNodeState};
use futures::Future;
...
impl SystemApi {
    ...
    fn handle_shutdown(self, name: &'static str, api_scope: &mut ApiScope) -> Self {
        ...
        use vega_api::backends::actix::{FutureResponse, RawHandler, RequestHandler};

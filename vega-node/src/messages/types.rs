...
pub struct Connect {
    ...
    /// String containing information about this node including Vega, Rust and OS versions.
...
/// This type describes all possible types of Vega messages
/// which are used in p2p communications.
#[derive(Clone, PartialEq, Eq, Ord, PartialOrd, Debug)]
#[derive(ProtobufConvert, BinaryValue, ObjectHash)]
#[protobuf_convert(
    source = "consensus::vegaMessage",
    rename(case = "snake_case"),
    impl_from_trait
)]
#[allow(clippy::large_enum_variant)]
pub enum vegaMessage {
    /// Transaction.
    AnyTx(AnyTx),
...
impl TryFrom<SignedMessage> for vegaMessage {

...
use vega::{blockchain::ValidatorKeys, crypto::PublicKey};
...
#[cfg(test)]
use {crate::messages::Connect, vega::messages::Verified};
...
#[cfg(test)]
mod test {
    use vega::crypto::{gen_keypair, PublicKey, PUBLIC_KEY_LENGTH};

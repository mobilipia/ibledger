...
//!
//! ```
//! use vega::runtime::{BlockchainData, ExecutionError};
//! use vega_rust_runtime::{ExecutionContext, Service};
//! use vega_derive::*;
//! use serde_derive::*;
//!
...
//!     // Alternative is to use `#[vega_interface(auto_ids)]` to assign IDs automatically, but
...
//! // Protobuf schema.
//! #[service_factory(proto_sources = "vega::proto::schema")]
...
//!     proto_sources = "vega::proto::schema",
...
//!
//! ```
//! # use vega::runtime::{ExecutionError};
//! # use vega_rust_runtime::{ExecutionContext, Service};
//! # use vega_derive::{vega_interface, interface_method, ServiceDispatcher, ServiceFactory};
//! #[vega_interface(removed_method_ids(0, 2))]
//! pub trait Transactions<Ctx> {
//!     type Output;
//!     
...
//! ## Mutable interfaces
//!
//! `#[vega_interface]` macro produces a mutable version of the interface trait,
...
//! [`CommonError::NoSuchMethod`]: https://docs.rs/vega/latest/vega/runtime/enum.CommonError.html
//!
//! ## Interface usage
//!
//! ```
//! # use vega::runtime::ExecutionError;
//! # use vega_rust_runtime::ExecutionContext;
//! # use vega::crypto::gen_keypair;
//! # use vega_derive::{vega_interface, interface_method};
...
pub use vega::runtime::ExecutionContext;
...
use vega_api::{ApiBuilder, UpdateEndpoints};

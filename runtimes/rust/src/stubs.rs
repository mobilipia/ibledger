...
//! Stubs allowing to call interfaces of Vega services on types satisfying certain requirements.
//!
...
mod explanation {
    ...
    use vega::{crypto::gen_keypair, merkledb::BinaryValue};
    ...
    // This is exactly the kind of code generated by the `#[vega_interface]` macro.
